    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query) {
                $edit = "<a href='".route('admin.content.edit', $query->id)."' class='btn btn-dark mr-1'><i class='far fa-edit'></i></a>";
                $delete = "<a href='".route('admin.content.destroy', $query->id)."' class='btn btn-danger delete-item ml-1'><i class='far fa-trash-alt'></i></a>";
