 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\ProductAdd> $productAdds
 * @property-read int|null $product_adds_count
 ...
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 * @method static \Illuminate\Database\Eloquent\Builder|ProductAdd newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|ProductAdd newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|ProductAdd query()
 * @method static \Illuminate\Database\Eloquent\Builder|ProductAdd whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|ProductAdd whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|ProductAdd whereName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|ProductAdd wherePrice($value)
 * @method static \Illuminate\Database\Eloquent\Builder|ProductAdd whereProductId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|ProductAdd whereUpdatedAt($value)
 */
	class ProductAdd extends \Eloquent {}
}
